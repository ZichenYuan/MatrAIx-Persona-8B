...
PLAYGROUND_TASK_INDEX: Dict[str, PlaygroundTaskEntry] = {
    ...
    "web_infobric-audit-v2-fleet": PlaygroundTaskEntry(
        application_type="web",
        site_name="Infobric Fleet (audit v2)",
        site_url="https://infobric.com/se/produkter/fleet/",
        output_artifact="page_audit.json",
        submission_profile="page_audit",
    ),
    "web_infobric-audit-v2-driving-log": PlaygroundTaskEntry(
        application_type="web",
        site_name="Electronic Driving Log (audit v2)",
        site_url="https://infobric.com/se/produkter/fleet/elektronisk-korjournal/",
        output_artifact="page_audit.json",
        submission_profile="page_audit",
    ),
    "web_infobric-audit-v2-equipment": PlaygroundTaskEntry(
        application_type="web",
        site_name="Infobric Equipment (audit v2)",
        site_url="https://infobric.com/se/produkter/equipment/",
        output_artifact="page_audit.json",
        submission_profile="page_audit",
    ),
    "web_infobric-audit-v2-hyrma": PlaygroundTaskEntry(
        application_type="web",
        site_name="Infobric Hyrma (audit v2)",
        site_url="https://infobric.com/se/produkter/hyrma/",
        output_artifact="page_audit.json",
        submission_profile="page_audit",
    ),

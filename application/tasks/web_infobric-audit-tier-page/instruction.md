...
- **page_id:** `tier_page`
- **Page to review:** the one below that matches **your Tier**.

| Your Tier | Page to open |
|---|---|
| Main contractor | https://infobric.com/se/vem-vi-hjalper/huvudentreprenorer/ |
| Subcontractor | https://infobric.com/se/vem-vi-hjalper/underentreprenorer/ |
| Developer | https://infobric.com/se/vem-vi-hjalper/byggherrar/ |
| Rental | https://infobric.com/se/vem-vi-hjalper/uthyrningsforetag/ |

Open **only** the page for your own Tier, and put that exact URL in `page_url`.
This is the page the supplier wrote specifically for companies like yours — judge
it on whether it actually speaks to you.

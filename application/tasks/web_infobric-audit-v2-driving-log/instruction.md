...
- **page_id:** `driving_log`
- **Page to review:** https://infobric.com/se/produkter/fleet/elektronisk-korjournal/
- **What this page is for:** a product page for Infobric's electronic driving log
  (elektronisk körjournal) — meant to tell an organisation that uses company cars,
  service vehicles, transport vehicles or pool cars what an electronic driving log is,
